...
public class ServerFrame extends JFrame {
    ...
    /**
     * This method create and arrange Swing components to display the status of the
     * server application
     * 
    ...
    /**
     * This method create and arrange Swing components the status of request send to
     * the client.
     * 
     * @param font - Default font for the application
     * @return Swing components organized in a panel.
